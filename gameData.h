...
#define GLH GOAL_LENGTH_HIGH
  constexpr auto GOAL_ODDS = 100;  // upper odds of GOAL moving and or changing size
#define GO GOAL_ODDS
...
#define GCPDR GOALS_DIMENSIONS_DATA_ROW
  constexpr auto GOAL_BUMP_BACK_RANGE = 3;  // used as the buffer area around GOAL and as the added distance to the to both bump back and kick out relocation 
#define GBBR GOAL_BUMP_BACK_RANGE
...
Push 'esc' at any time to exit game.  Push any other key to play.\n";
