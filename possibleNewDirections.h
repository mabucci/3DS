...
The first step in occuping the GOAL, PLAYER or GAME must first move into the GOAL.  This is done by simply moving into the GOAL's area.   The PLAYER has at the start of the game 26 cards;\n\
